...
const Footer = () => {
    const kategorije = [
        { id: "Alati", naziv: "Alati", podKategorija: ["Kompresori","Dizalice","Aparati za zavarivanje",'Aku alati', "Agregati",'Električni alati', 'Ručni alati', 'Setovi gedora', 'Specijalni setovi'] },
        { id: "Dvorište i bašta", naziv: "Dvorište i bašta", podKategorija: ["Trimeri","Pumpe za navodnjavanje","Motorne testere",'Oprema za trimere', 'Motorni bušači rupa', 'Creva i brze spojke', 'Makaze za orezivanje', 'Ostali baštenski alati'] },
        ...
        {id:'Kucni aparati', naziv:'Kucni aparati', podKategorija:['Ventilatori']}
      ];
                ...
                <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                    <div className="mx-auto max-w-sm lg:max-w-none">
                        <p className="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
                            Želis da ostanemo u kontaktu? Poseti i ostale naše mreže.
                        </p>
