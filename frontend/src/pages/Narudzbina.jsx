...
const Narudzbina = () => {
  ...
  return (
    <div className=' max-w-screen-xl px-6 py-8  sm:py-12 lg:px-8 flex flex-wrap items-center justify-center gap-10'>
      <CartModal />
      <div className="pt-4 pb-10">
        ...
        <div className="pt-4 md:pt-5">
          <div className="flex justify-between">
            <input type="text" placeholder="First Name" className="form-input mb-4 mr-2 sm:mb-5" id="first_name" value={formData.first_name} onChange={handleChange} />
            <input type="text" placeholder="Last Name" className="form-input mb-4 ml-1 sm:mb-5" id="last_name" value={formData.last_name} onChange={handleChange} />
          </div>
          ...
          <div className="flex justify-between">
            <input type="text" placeholder="Country/Region" className="form-input mb-4 mr-2 sm:mb-5" id="country" value={formData.country} onChange={handleChange} />
            <input type="number" placeholder="Post code" className="form-input mb-4 ml-1 sm:mb-5" id="post_code" value={formData.post_code} onChange={handleChange} />
          </div>
