...
const Proizvodi = () => {
  ...
  const kategorije = [
    ...
    { id: "Dvorište i bašta", naziv: "Dvorište i bašta", podKategorija: ["Trimeri","Motorne testere","Pumpe za navodnjavanje",'Oprema za trimere', 'Motorni bušači rupa', 'Creva i brze spojke', 'Makaze za orezivanje', 'Ostali baštenski alati'] },
