...
export default function NarudzbinaTable({ initialNarudzbine }) {
  ...
  const handleDelete = async (n) => {
    ...
    setLoading(true)
    try {
      await axios.delete(`https://alatinidza.rs/api/kupac/${n.kupac.id}`);
      await axios.delete(`https://alatinidza.rs/api/korpa?brojKorpe=${n.brojKorpe}`);
      await axios.delete(`https://alatinidza.rs/api/narudzbina/${n.id}`);
